...
class Lcatalogue {
    ...
    public function product($catalogue_id,$links,$per_page,$page)
    {
        $CI =& get_instance();
        $CI->load->model('Catalogues');
        $CI->load->model('Categories');
        $product_list = $CI->Catalogues->product($catalogue_id,$per_page,$page);
    ...
    public function product_catalogue_search_list($catalogue_id,$product_clave,$product_name)
    {
        $CI =& get_instance();
        $CI->load->model('Catalogues');
        $CI->load->model('Categories');
        $product_list = $CI->Catalogues->product_catalogue_search_item_list($catalogue_id,$product_clave,$product_name);
        $category_department_list 	=	$CI->Categories->department_list();
