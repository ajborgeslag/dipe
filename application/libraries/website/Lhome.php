...
class Lhome {
	...
	public function home_page()
	{
        ...
        else
        {
            ...
            $CI->session->set_userdata('store_id',/*,$storeId*/'001');
        }
        ...
        $products_recomend      = $CI->Catalogues->products_recomend_home($storeId);
        $products_new      = $CI->Catalogues->products_new_home($storeId);
        $products_ofert      = $CI->Catalogues->products_ofert_home($storeId);
	...
	public function checkout()
	{
		...
		$footer_block 			= $CI->Homes->footer_block();
		$slider_list 			= $CI->web_settings->slider_list();
        $web_settings 			= $CI->web_settings->setting();
		$block_list 			= $CI->Blocks->block_list(); 
		$currency_details 		= $CI->Soft_settings->retrieve_currency_info();
		$Soft_settings 			= $CI->Soft_settings->retrieve_setting_editdata();
		$languages 				= $CI->Homes->languages();
		...
		$data = array(
                ...
                'store_default' => $store_default,
                'store' => $store,
                'cost_send' => $web_settings[0]['cost_send'],
                'amount_free_send' => $web_settings[0]['amount_free_send'],
    ...
    public function checkout_invoice($idOrder)
    {
        ...
        $payment_method = $CI->Orders->order_payment_method_by_id($idOrder);
        ...
        $data = array(
            ...
            'company_info' => $company_info[0],
            'idOrder' => $idOrder,
            'fac_fp' => $payment_method['forma_pago'],
            'stores'        => $stores,
            'store_default' => $store_default
    ...
    public function redirect_pay()
    {
        ...
        $redirectPay= $CI->parser->parse('website/redirect_pay',$data,true);
        return $redirectPay;
    }
