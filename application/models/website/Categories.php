...
class Categories extends CI_Model {
	...
	{
        $this->db->select('
                    product_information.*,catalogue_products.price as price_store,catalogue_products.onsale_price as onsale_price_store,catalogue_products.onsale as onsale_store,catalogue_products.stock as stock_store')
    ...
    //Category product
    public function product($per_page,$page,$store_id)
    {
        $this->db->select('
                    product_information.*,catalogue_products.price as price_store,catalogue_products.onsale_price as onsale_price_store,catalogue_products.onsale as onsale_store,catalogue_products.stock as stock_store')
            ->from('catalogue_products')
    ...
    public function product_count($store_id)
    {
        $this->db->select('
                    product_information.*,catalogue_products.price as price_store,catalogue_products.onsale_price as onsale_price_store,catalogue_products.onsale as onsale_store')
            ->from('catalogue_products')
