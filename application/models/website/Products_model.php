...
class Products_model extends CI_Model {
    ...
    public function product_info_by_store($p_id,$store_id)
    {
        $query=$this->db->select('
                    product_information.*,product_category.category_name,catalogue_products.price as price_store,catalogue_products.onsale_price as onsale_price_store,catalogue_products.onsale as onsale_store,catalogue_products.stock as stock_store')
            ...
            ->where('product_information.product_id',$p_id)
