                                        ...
                                        <tr>
											...
											<td>
                                                <?php if($order['timbrado']==1){ ?>
													...
													<a href="<?php echo base_url('Corder/store_print_order/'.$order['order_id']); ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo "Imprimir Pedido"; ?>"><i class="fa fa-print" aria-hidden="true"></i></a>
