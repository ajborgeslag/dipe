                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                foreach ($order_all_data as $items):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo (($position==0)?$currency." ". $this->cart->format_number($items['rate']-$items['discount']):$this->cart->format_number($items['rate']-$items['discount'])." ". $currency) ?></td>

                                        <td><?php echo (($position==0)?$currency ." ". $this->cart->format_number(($items['rate']-$items['discount']) * $items['quantity']):$this->cart->format_number(($items['rate']-$items['discount']) * $items['quantity'])." ". $currency) ?></td>
                                    </tr>
