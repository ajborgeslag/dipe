                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                               <input type="email" tabindex="3" class="form-control" name="email" id="email" placeholder="<?php echo display('email') ?>"  required />
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="password" tabindex="2" class="form-control" id="password" name="password" placeholder="<?php echo display('password') ?>" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="user_type" id="user_type" required="">
                                    ...
                                    <option value="6"><?php echo 'Contador'; ?></option>
                                  </select>
                            </div>
                        </div>

                        <div class="form-group row" id="payment_from_1" style="display: none">
