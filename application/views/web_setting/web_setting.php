                ...
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Cweb_setting/update_web_settings/{setting_id}', array('class' => 'form-vertical','id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="map_langitude" class="col-sm-3 col-form-label"><?php echo "Costo de Envío" ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="cost_send" id="cost_send " placeholder="<?php echo "Costo de Envío" ?>" required value="{cost_send}">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="map_langitude" class="col-sm-3 col-form-label"><?php echo "Monto para Envío Gratis" ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="amount_free_send" id="amount_free_send " placeholder="<?php echo "Monto para Envío Gratis" ?>" required value="{amount_free_send}">
                            </div>
                        </div>
