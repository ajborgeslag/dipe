                                ...
                                <div class="card p-xs-0 p-md-2 p-lg-4 col-lg-9 mt-5 mb-5">
                                    <div class="form-row" id="form-row1-step-1" role="form" data-toggle="validator">
                                        <div class="col form-group">
                                            ...
                                            <select class="form-control" name="fac_fp" id="fac_fp" required data-required-error="Campo obligatorio." disabled>
                                                <!--<option value=""><?php echo display('select_one')?></option>-->
                                                <option value="04" <?php if($fac_fp=='04'){echo 'selected';} ?> > Tarjeta de crédito</option>
                                                <option value="28" <?php if($fac_fp=='28'){echo 'selected';} ?> > Tarjeta de débito</option>
                                            </select>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="col form-group">
