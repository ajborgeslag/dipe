            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="category_name" class="col-sm-4 col-form-label"><?php echo "Tienda";?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control col-sm-7"  name="store_id" required="" data-required-error="Campo obligatorio.">
                                    <option value="">Seleccione</option>
                                    <?php if ($stores) {
                                        foreach ($stores as $sto) {
                                            ?>
                                            <?php if($sto['store_id']==$store_id){ ?>
                                            <option selected value="<?php echo $sto['store_id']?>"><?php $nameStore = $sto['store_name']; $nameStore = strtolower($nameStore); $nameStore = ucfirst($nameStore); echo $nameStore; ?></option>
                                            <?php }else {?>
