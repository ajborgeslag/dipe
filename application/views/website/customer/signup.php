                ...
                <div class="card">
                    ...
                    <article class="card-body">
                        <form action="<?php echo base_url('user_signup')?>" method="post" data-toggle="validator" data-disable="false">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-12">Tienda</label>
                                </div>
                                <select class="custom-select col-sm-7"  name="store_id" required="" data-required-error="Campo obligatorio.">
                                ...
                                <a class="col-sm-5" href="<?php echo base_url('stores') ?>">Mapa de tiendas</a>
                                <div class="help-block with-errors"></div>
                                <!--<small class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                            </div> <!-- form-group end.// -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-12"><a href="<?php echo base_url('terms_condition') ?>">Téminos y Condiciones</a></label>
                                </div>
                                <input type="checkbox" required="" data-required-error="Campo obligatorio."  id="checkbox_term_condition">
