...
<!--                        <div class="owl-init slider-main owl-carousel" data-items="1" data-nav="true" data-dots="false">-->
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                if ($slider_list) {
                                    ?>
                                    <div class="carousel-home carousel-item active">
                                    ...
                                    foreach ($slider_list as $slider) {
                                        ?>
                                        <div class="carousel-home carousel-item ">
                                ...
                                <figcaption class="p-2 w-75">
                                    ...
                                    <div class="price-wrap">
                                        <span class="price-new">
                                                ...
                                                ?>
                                                <?php if ($products_ofert[$i]['onsale_store'] == 1 && !empty($products_ofert[$i]['onsale_price_store'])) { ?>
                                                    <span class="price-new">
                                                    <?php
                                                    if ($target_con_rate > 1) {
                                                        $price = $products_ofert[$i]['onsale_price_store'] * $target_con_rate;
                                                    ...
                                                    <?php
                                                    if ($target_con_rate > 1) {
                                                        $price = $products_ofert[$i]['price_store'] * $target_con_rate;
                                                        echo (($position1==0)?$currency1." ".number_format($price, 2, '.', ','):number_format($price, 2, '.', ',')." ".$currency1);
                                                    }
                                                ...
                                                <?php }else{ ?>
                                                    ...
                                                    <?php
                                                    if ($target_con_rate > 1) {
                                                        $price = $products_ofert[$i]['price_store_store'] * $target_con_rate;
                                                        echo (($position1==0)?$currency1." ".number_format($price, 2, '.', ','):number_format($price, 2, '.', ',')." ".$currency1);
                                                    }
        ...
        <div class="card">
            <div class="row ">
                ...
                <div class="col-md-9 px-5">
                    ...
                    <!-- ============== owl slide items  ============= -->
                    <div class="owl-carousel owl-init slide-items" data-items="5" data-margin="5" data-dots="false" data-nav="true">
                        <?php for ($i=0; $i < count($products_new); $i++) { if($products_new[$i]['price_store']>0){ ?>
                        <div class="item-slide dipe-min-with-150 hover01">
                                ...
                                <figcaption class="info-wrap border-0 dipe-oferta-info-wrap p-1">
                                    ...
                                    <div class="action-wrap">
                                        ...
                                        <div class="price-wrap h5 dipe-nomargin">
                                            ...
                                            ?>
                                            <?php if($products_new[$i]['onsale_store']=="1"){ ?>
                                                <span class="price-new">
                                                <?php
                                                if ($target_con_rate > 1) {
                                                    $price = $products_new[$i]['onsale_price_store'] * $target_con_rate;
                                                    echo (($position1==0)?$currency1." ".number_format($price, 2, '.', ','):number_format($price, 2, '.', ',')." ".$currency1);
                                                }
                                                ...
                                                <del class="price-old">
                                                    <?php
                                                    if ($target_con_rate > 1) {
                                                        $price = $products_new[$i]['price_store'] * $target_con_rate;
                                                        echo (($position1==0)?$currency1." ".number_format($price, 2, '.', ','):number_format($price, 2, '.', ',')." ".$currency1);
                                                    }
        ...
        <figure class="mt-5 banner bg-secondary">
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url('assets/website/maqueta/images/banners/3.jpg')?>" alt="Third slide">
                    </div>
                </div>
            </div>
        </figure>
        ...
        <div class="container">
            ...
            <figure class="mt-5 banner bg-secondary">
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="<?php echo base_url('assets/website/maqueta/images/banners/2.jpg')?>" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo base_url('assets/website/maqueta/images/banners/1.jpg')?>" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo base_url('assets/website/maqueta/images/banners/3.jpg')?>" alt="Third slide">
                        </div>
...
<div class="row">
    ...
    ?>
    <?php for ($i=0; $i < count($products_recomend); $i++) { if($products_recomend[$i]['price_store']>0){ ?>
    <div class="col-md-4 col-sm-6 col-lg-2 pt-1 hover01">
        ...
        <figure class="card card-product border-0 dipe-nomargin">
            ...
            <div class="bottom-wrap text-center font-weight-bold dipe-noborder pt-0">
                <div class="price-wrap ">
                    <?php if($products_recomend[$i]['onsale_store']==1){ ?>
                        <span class="price-new">
                            <?php
                            if ($target_con_rate > 1) {
                                $price = $products_recomend[$i]['onsale_price_store'] * $target_con_rate;
                                echo (($position1==0)?$currency1." ".number_format($price, 2, '.', ','):number_format($price, 2, '.', ',')." ".$currency1);
                            }
                        ...
                        <del class="price-old">
                            <?php
                            if ($target_con_rate > 1) {
                                $price = $products_recomend[$i]['price_store'] * $target_con_rate;
                                echo (($position1==0)?$currency1." ".number_format($price, 2, '.', ','):number_format($price, 2, '.', ',')." ".$currency1);
                            }
    ...
    <figure class="mt-5 banner bg-secondary">
        <div id="carouselpromo2" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="<?php echo base_url('assets/website/maqueta/images/banners/3.jpg')?>" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo base_url('assets/website/maqueta/images/banners/2.jpg')?>" alt="Second slide">
                </div>
